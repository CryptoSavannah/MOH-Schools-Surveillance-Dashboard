...
{
    $result = array();
    $result[] = array('caption' => 'Disease', 'short_caption' => 'Disease', 'filename' => 'disease.php', 'name' => 'disease', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Encounter', 'short_caption' => 'Encounter', 'filename' => 'encounter.php', 'name' => 'encounter', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Facility', 'short_caption' => 'Facility', 'filename' => 'facility.php', 'name' => 'facility', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Patient', 'short_caption' => 'Patient', 'filename' => 'patient.php', 'name' => 'patient', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
